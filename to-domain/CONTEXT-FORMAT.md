...
**Multiple contexts:** A `docs/CONTEXT-MAP.md` lists the contexts, where they live, and how they relate to each other (each context keeps its own `CONTEXT.md` co-located with its code):
